// lib/features/onboarding/screens/onboarding_screen_002.dart

import 'package:fatura_yeni/features/onboarding/screens/onboarding_screen_003.dart';
...
class OnboardingScreen2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      // Scaffold rengi temadan otomatik olarak gelir (light/dark)
      body: SafeArea(
        child: Padding(
    ...
    return Column(
      ...
      children: [
        ...
        Text(
          ...
          style:
              Theme.of(context).textTheme.displayLarge, // Stil temadan geliyor
        ),
        const Spacer(),
        Row(
          mainAxisAlignment: MainAxisAlignment.center,
  ...
  Widget _buildButtons(BuildContext context) {
    return Column(
      ...
      children: [
        // Butonların tüm stilleri artık AppTheme dosyasından geliyor.
        ElevatedButton(
          onPressed: () {
            Navigator.of(context).push(
                MaterialPageRoute(builder: (_) => const OnboardingScreen3()));
            // Bir sonraki ekrana yönlendirme eklenecek
          },
